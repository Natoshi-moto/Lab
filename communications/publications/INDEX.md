# Publications index (newest first)

**status_authority:** `NONE`  
**Rule:** Every AI end-of-round report adds **one row at the top**. Never delete historical rows.
...
1. File the report under `rounds/<TRACK>/`.  
2. Insert a new table row **above** the previous newest entry.  
3. Link the path relative to this file.
