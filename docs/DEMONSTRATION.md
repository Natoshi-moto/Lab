...
| DEMO-003 | task-to-route compiler | `tests/test_route.py`; generated R001 route pack | Included files, exclusions, baseline and output contract are explicit; unsafe paths are rejected | No proof that selected context is sufficient |
