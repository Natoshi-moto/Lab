...
| `products/noted-host/public/nexus/os/blocks/Eidolin/src/` and `products/noted-host/public/nexus/os/blocks/Eidolin/test/` | A deterministic creature/world/battle/save vertical slice and tests exist. | The public package is not complete while its referenced `dist/src/runtime.js` is absent. |
