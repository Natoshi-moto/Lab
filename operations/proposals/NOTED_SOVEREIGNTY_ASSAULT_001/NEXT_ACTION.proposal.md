...
3. **T-06 disposition (update 2026-07-22):** launch-path quarantine **done** (PR #66 + session 1 CARD-01). Remaining: keep regression watch; wire check into CI (G-08); do not claim history scrubbed.
