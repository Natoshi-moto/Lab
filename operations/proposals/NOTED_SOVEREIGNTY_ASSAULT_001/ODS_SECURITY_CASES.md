...
| **ODS-SEC-006** | T-06 | File-existence + registry check | `nexus-agent-v0.12.html` (either path) is absent from shipped output; not referenced in `block-registry.json` or `Nexus_OS.html` | **FAIL** (both present) |
