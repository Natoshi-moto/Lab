...
The default Claude assignment is the **R001 blind audit**. Read `AUDIT_START_HERE.md` or invoke:
...
- Put proposed observations only in the declared audit return path or a `claude/audit-r001-*` branch.
...
Use `operations/audits/AUD-R001-CLAUDE-BLIND/OBSERVATION_TEMPLATE.json`. One claim per observation. Name exact files, tests, limitations, and anything not inspected.
